                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="overflow-hidden">
                        <h1 class="text-xl font-bold tracking-wide flex items-center gap-2 truncate">
                            {{ setup.destination || '旅遊計畫' }} <i class="ph-fill ph-airplane-tilt text-sm opacity-70"></i>
                        </h1>
                    ...
                    try {
                        ...
                        if (geoData && geoData.length > 0) {
                            ...
                            if (recommendationsMap[key].length === 0) {
                                recommendationsMap[key] = [{ name: '找不到推薦，請嘗試更精確地點', location: item.location, note: '' }];
                            }
                        }
                    } catch (e) {
